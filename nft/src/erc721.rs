// Imported from https://github.com/OffchainLabs/stylus-workshop-nft/blob/main/src/ERC721.rs
// Modified a bit to use #[derive(SolidityError)]
    ...
    fn call_receiver<S: TopLevelStorage>(
        ...
        if to.has_code() {
            ...
            let received = receiver
                .on_erc_721_received(&mut *storage, msg::sender(), from, token_id, data).unwrap()
                .0;
